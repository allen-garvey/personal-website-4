const projects = [
    ...
    },
    {
        ...
        description: 'A project created using Elixir and the Phoenix Framework to house various custom content management systems (CMS). These include organization for book and movie reviews, bookmarks, my music library, inspirational quotes, artwork and photography. <br><br>From a technical perspective, each share custom authentication middleware, which allows each app to share users and implement the same seamless authentication flow. It also includes custom mix (scripting) tasks, such as to import and convert images for my photo library, or to generate the static site for my artwork at <a href="https://strangescenery.com">strangescenery.com</a>. It is structured as an umbrella project, which allows the advantages of a monolith, as projects can easily share code and use the same instance of the BEAM virtual machine for increased efficiency, but allows the flexibility of microservices, as each sub-project can have its own dependencies and configuration..',
    },
    // {
    //     title: 'dminjs',
    //     github: 'dminjs',
